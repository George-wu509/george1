...
![CPU简单信息](cpu_specs.png)

![GPU的简单信息对比](gpu_specs.png)
...
![GPU的简单信息对比](gpu_memory_arch.png)

![GPU的内存架构容量信息](gpu_memory.png)
