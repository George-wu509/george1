...
![Deeplearning4j](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-2.png)
...
![Mahout](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-3-1.png)

&emsp;&emsp;Mahout应用场景：

![Mahout](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-3-2.png)
...
![架构图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-4-1.png)
<center>架构图</center>


&emsp;&emsp;MLlib目前支持4种常见的机器学习问题: 分类、回归、聚类和协同过滤，MLlib在Spark整个生态系统中的位置如图下图所示。
![生态系统位置](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-4-2.png)
...
![架构图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-5-1.png)
<center>架构图</center>

![任务调度图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-5-2.png)
<center>任务调度图</center>
...
![Spark Streaming架构图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-6-1.png)
...
![Spark Streaming基本原理图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-6-2.png)
...
![深度学习集群](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-9-1.png)
...
![深度学习集群](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-9-2.png)
<center>深度学习集群</center>

&emsp;&emsp;为分布式训练进行分片
在分布式训练环境中，每个进程通常负责训练数据的一个子集。一个进程的数据子集与其他进程的数据子集正交。Petastorm 支持将数据集的读时分片转换为正交的样本集。
![Petastorm 将数据集的非重叠子集提供给参与分布式训练的不同机器](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-9-3.png)
<center>Petastorm 将数据集的非重叠子集提供给参与分布式训练的不同机器</center>

&emsp;&emsp;本地缓存
Petastorm 支持在本地存储中缓存数据。当网络连接速度较慢或带宽很昂贵时，这会派上用场。
![本地缓存](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-9-4.png)
...
![架构图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-10-1.png)
<center>架构图</center>

![运行流程图](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-2-10-2.png)
<center>运行流程图</center>
...
![](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-4-1.png)
...
![](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-4-2.png)
...
![](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-4-3.png)
...
![](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-4-4.png)
...
![](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-4-5.png)
...
![F-Measure](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-9-2-1.png)

&emsp;&emsp;当参数α=1时，就是最常见的F1，也即

![F-Measure](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-9-2-2.png)
...
![E值](CVML%20-%20DL%20AI/ch18_后端架构选型、离线及实时计算/img/18-9-3-1.png)
