...
| setting                       |                                                                                                      |                     |
| ----------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------- |
| [[Normalization and dropout]] | Layer normalization,  <br>Batch normalization  <mark style="background: #FF5582A6;">@要會公式跟手寫!</mark> | **model之內**(relu之前) |
