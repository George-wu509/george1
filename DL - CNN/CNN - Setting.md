...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[[圖像分類loss]]**<br><br>**output**(1張圖):<br><br>All confidence scores:<br>{"cat": 0.92, <br>"dog": 0.03, <br>"bird": 0.05}<br>                                                                          | 分類損失 <mark style="background: #ADCCFFA6;">classification</mark> loss<br>(cross-entropy/Focal loss)                                                                                                                                                                                                                                                                                                     | Precision = TP/(TP+FP)<br>Recall = TP/(TP+FN)<br><br>[[###F1-Score]] = <br>2(Precision x Recall) <br>/ (Precision + Recall)<br><br>[[###Confusion Matrix]]<br>ROC 曲線與 AUC,<br>[[###Top-1 Accuracy]], <br>[[###Top-5 Accuracy]]<br><br>p.s<br>Top-1,5 準確率是整體指標<br>而Precision,Recall,F1都是<br>針對個別類別,可以平均<br>得到整體指標 |
|                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                  |
| **[[目標檢測loss]]**<br><br>**output**(多個目標):<br><br>Boundary Box: <br>(x, y, w, h)<br><br>All confidence scores<br>[P(背景), P(汽車), P(行人)]<br>                                                               | 邊界框檢測損失 <br><mark style="background: #FFB86CA6;">Bounding Box Detection</mark> Loss<br>(L1, Smooth L1 loss, IoU Loss)<br><br>分類損失 <mark style="background: #ADCCFFA6;">classification</mark> loss<br>(cross-entropy/Focal loss)<br><br>信度損失 <mark style="background: #FFF3A3A6;">Confidence</mark> Loss<br>(BCE loss)                                                                                  | <mark style="background: #BBFABBA6;">mAP</mark>(mean avg precision)<br><mark style="background: #BBFABBA6;">mAR</mark>(mean average recall)<br><br>AP就是recall(x)-precision<br>曲線下面面積(單一類別)<br><br>mAP就是所有類別AP的平均<br>ex: mAP@[0.5:0.05:0.95]                                                                      |
|                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                  |
| **[[實例分割loss]]**<br><br>**output**(多個目標):<br><br>"bbox": <br>(x, y, w, h)<br><br>"mask"<br>mask all pixel<br><br>"class":<br>"cat"<br><br>"confidence": (單一)<br>0.93                                    | 邊界框檢測損失 <br><mark style="background: #FFB86CA6;">Bounding Box Detection</mark> Loss<br>(L1, Smooth L1 loss, IoU Loss)<br><br>掩码損失 <mark style="background: #FF5582A6;">Mask</mark> Loss<br>(Dice Loss)<br><br>分類損失 <mark style="background: #ADCCFFA6;">classification</mark> loss<br>(cross-entropy/Focal loss)<br><br>信度損失 <mark style="background: #FFF3A3A6;">Confidence</mark> Loss<br>(BCE loss) | mAP(mean avg precision)<br>mAR(mean average recall)<br><mark style="background: #BBFABBA6;">mean IOU</mark><br><br>ex: mAP@[0.5:0.05:0.95]                                                                                                                                                                       |
|                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                  |
| **[[語義分割loss]]**<br><br>**output**(1張圖):<br><br>與輸入圖像尺寸相同的<br>像素級標籤圖,每個元素<br>的值代表該像素類別ID<br>                                                                                                            | 掩码損失 <mark style="background: #FF5582A6;">Mask</mark> Loss<br>(Dice Loss)<br>(IoU Loss)<br>(Pixel-wise <br>Cross-Entropy Loss)<br>(Focal Loss)                                                                                                                                                                                                                                                         | <mark style="background: #BBFABBA6;">PA(Pixel Accuracy)</mark><br>mPA(mean pixel Accuracy)<br>IoU, mIoU, <mark style="background: #BBFABBA6;">Dice, mDice</mark>                                                                                                                                                 |
|                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                  |
...
|                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                  |
| **[[圖像質量增強loss]]**<br><br>**output**<br>(1張圖):<br><br>Generator:<br>生成圖像<br><br>Discriminator:<br>概率值(0-1)                                                                                              | 像素級損失 Pixel-wise Loss<br>(L1/L2 loss)<br><br>感知損失 Perceptual Loss<br>(VGG/Feature Matching Loss)<br><br>對抗損失 Adversarial Loss<br>(GAN Loss)<br><br>紋理損失Texture loss                                                                                                                                                                                                                                    | <mark style="background: #BBFABBA6;">PSNR<br>SSIM</mark><br><br>MSE<br>MAE                                                                                                                                                                                                                                       |

|                                                                                     |                                               |
| ----------------------------------------------------------------------------------- | --------------------------------------------- |
| 分類損失 <mark style="background: #ADCCFFA6;">classification</mark> loss                | Cross-Entropy Loss<br>[[Focal Loss]]          |
| 邊界框檢測損失 <br><mark style="background: #FFB86CA6;">Bounding Box Detection</mark> Loss | IoU loss, L1 Loss<br>[[Smooth L1 Loss]]       |
| 信度損失 <mark style="background: #FFF3A3A6;">Confidence</mark> Loss                    | [[BCE loss]]<br>(Binary Cross-Entropy loss)   |
| 掩码損失 <mark style="background: #FF5582A6;">Mask</mark> Loss                          | IoU Loss<br>[[Dice Loss]] (用segmentation)     |
