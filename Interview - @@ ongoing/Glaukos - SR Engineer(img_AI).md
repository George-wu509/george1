...
1. 5-8+ years (3-5+ years with Master’s degree or 0-4+ years with PhD) experience developing <mark style="background: #BBFABBA6;">software and algorithms for AI/ML and Computer Vision applications</mark>.
2. Proven track record of developing and deploying AI/ML models and Computer Vision algorithms in commercial products, preferably in a regulated environment, is a strong plus.
3. Expertise in machine learning frameworks (e.g., <mark style="background: #BBFABBA6;">PyTorch</mark>).
4. Expertise in <mark style="background: #BBFABBA6;">Computer Vision Algorithms development</mark>.
5. Knowledge of <mark style="background: #BBFABBA6;">machine vision system design</mark>.
6. Strong programming skills in <mark style="background: #BBFABBA6;">Python</mark> or similar languages.
7. Working knowledge of one or more systems programming languages such as <mark style="background: #BBFABBA6;">C++</mark>, C#, Rust, and their associated development environments is a strong plus.
8. Knowledge of <mark style="background: #BBFABBA6;">medical imaging</mark> or related applications. 
9. Experience in the healthcare or medical device industry, medical regulations and standards and preparing technical documentation for regulatory submissions as strong plus.
10. Strong written and verbal communication skills are essential 
11. A minimum Bachelor of Science degree in Computer Science, Electrical Engineering, Biomedical Engineering, or a related field, with a focus on AI/ML.

1. 5-8 年以上（碩士學位 3-5 年以上，博士 0-4 年以上）開發 AI/ML 和電腦視覺應用軟體和演算法的經驗。
2. 在商業產品中（最好是在受監管的環境中）開發和部署人工智慧/機器學習模型和電腦視覺演算法的良好記錄是一個強大的優勢。
3. 機器學習框架（例如 PyTorch）的專業知識。
4. 電腦視覺演算法開發方面的專業知識。
5. 了解機器視覺系統設計。
6. 具備較強的 Python 或類似語言程式設計能力。
7. 具備一種或多種系統程式語言（例如 C++、C#、Rust 及其相關開發環境）的工作知識者優先。
8. 了解醫學影像或相關應用。
9. 擁有醫療保健或醫療器材產業、醫療法規和標準以及為監管提交準備技術文件的經驗者優先。
10. 強大的書面和口頭溝通能力是必不可少的
 11. 至少擁有電腦科學、電機工程、生物醫學工程或相關領域的理學學士學位，重點是人工智慧/機器學習。
...
|                                           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Cornea <br>角膜<br><br>Keratoconus <br>圆锥角膜 | **1. iLink™角膜交联疗法**<br>iLink™是一种用于治疗圆锥角膜的角膜交联（Corneal Cross-Linking）疗法。圆锥角膜是一种进行性角膜疾病，导致角膜变薄和突出，影响视力。iLink™通过使用紫外线A（UVA）和核黄素（维生素B2）相结合，增强角膜的强度，阻止或减缓疾病的进展。 <br><br>**2. Photrexa®系列药物**<br>在iLink™疗法中，Photrexa®和Photrexa® Viscous是两种关键的光敏剂药物。这些药物在紫外线照射下，诱导角膜胶原纤维之间形成新的交联，从而增强角膜的刚性和稳定性。 <br><br>**3. KXL®系统**<br>KXL®系统是一种专用于iLink™疗法的紫外线照射设备。该系统提供精确的UVA照射，确保治疗的安全性和有效性。 <br><br>**适应症：**<br>- **圆锥角膜（Keratoconus）：** iLink™疗法主要用于治疗圆锥角膜，旨在阻止或减缓疾病的进展，维护患者的视力。 <br>- **角膜扩张（Ectasia）：** 该疗法也适用于某些角膜扩张的病例，帮助增强角膜强度。<br>    <br>**治疗过程：**<br>1. **药物应用：** 将Photrexa®或Photrexa® Viscous滴入患者的眼中，使核黄素渗透到角膜组织中。    <br>2. **紫外线照射：** 使用KXL®系统对角膜进行UVA照射，激活核黄素，促进胶原纤维之间的交联。<br>3. **恢复期：** 治疗后，患者需要遵循医生的指导进行护理，以确保角膜的愈合和治疗效果。                                                                                                       |
| Glaucoma <br>青光眼<br><br>Glaucoma<br>青光眼   | **1. iStent系列產品**<br>- **iStent®：** 這是全球首款微創青光眼手術（MIGS）裝置，旨在降低眼內壓（IOP），適用於接受白內障手術的開角型青光眼患者。     <br>- **iStent inject®：** 第二代產品，包含兩個微型支架，可在單次手術中植入，進一步提高降低眼內壓的效果。 <br>- **iStent inject® W：** 最新版本，設計上進一步優化，提供更高的精確度和有效性。 <br>    <br>**2. iStent infinite®**<br>- **iStent infinite®：** 這是一種包含三個支架的裝置，專為需要進一步降低眼內壓的青光眼患者設計，特別適用於藥物和手術治療無效的原發性開角型青光眼患者。 <br>    <br>**3. iDose TR**<br>- **iDose TR：** 這是一種微型眼內植入物，持續釋放前列腺素類似物travoprost，用於降低開角型青光眼或高眼壓患者的眼內壓，已獲得美國FDA批准。 <br>    <br>**適應症：**<br>- **原發性開角型青光眼（POAG）：** 這是最常見的青光眼類型，Glaukos的產品旨在降低這些患者的眼內壓，減少視神經損傷的風險。<br>- **高眼壓症（Ocular Hypertension）：** 對於眼內壓高於正常但尚未出現視神經損傷的患者，這些產品可幫助控制眼內壓，預防青光眼的發展。<br>**產品功能：**<br>- **降低眼內壓：** 通過改善房水的引流，這些裝置有效降低眼內壓，減少對視神經的壓力。<br>- **減少藥物依賴：** 許多青光眼患者需要每日使用多種眼藥水，這些植入物可減少對藥物的依賴，提高生活質量。<br>- **微創手術：** 這些裝置的植入過程為微創手術，恢復時間短，併發症風險低。 |
| Retina 視網膜                                | Glaukos公司专注于开发创新的眼科医疗技术，针对视网膜疾病，特别是年龄相关性黄斑变性（AMD）和糖尿病黄斑水肿（DME），正在研发多种微创、可生物降解的持续释放药物递送平台。 <br><br>**主要研发方向：**<br>- **微创药物递送系统：** 这些平台旨在通过微创手术将药物直接递送至眼内，持续释放治疗药物，减少患者对频繁注射的需求，提高治疗的依从性和效果。<br><br>**目标疾病：**<br>- **年龄相关性黄斑变性（AMD）：** 这是一种常见的视网膜疾病，主要影响老年人，导致中心视力丧失。<br>- **糖尿病黄斑水肿（DME）：** 这是糖尿病患者常见的并发症，导致视力模糊和丧失。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
下一代眼科設備可能會嵌入更多的AI功能，實現更智能的自動化和患者管理功能。例如，智能眼鏡（Smart Glasses）可以實時監控視力變化，並向醫生提供患者的實時數據，讓醫生能及時調整治療方案。
...
- **進展跟蹤** (<mark style="background: #FFB86CA6;">Progression Tracking</mark>)：AI可通過分析多時間點的OCT數據，幫助醫生跟蹤疾病進展，如糖尿病視網膜病變的演變。
...
- **OCULUS Pentacam Dataset**：包含大量的角膜地形圖數據，常用於角膜疾病研究。
...
- **Mask R-CNN**:
    ...
    - **主要針對物體檢測和實例分割** (Primarily Designed for Object Detection and Instance Segmentation):  
...
**Performance Comparison of U-Net, Mask R-CNN, YOLO, and ViT-Based Methods**
